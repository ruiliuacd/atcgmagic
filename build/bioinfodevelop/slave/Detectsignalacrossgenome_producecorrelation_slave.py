...
#         freq_xaxisKEY_yaxisVALUE_seq_list[]
    ...
    for currentchrID,currentchrLen in chromlist:
        ...
        target_ref_SNPs=variantUtils.alignmultPopSnpPos(listofpopvcfmapOfAChr, "o")
...
#                 print("multple allele",snp_aligned)
            ...
            OUTgroups=Utils.getOUTgrouptypeForOneSNP(snp,outgroupidx_in_topleveltable)
            Anc_base_idx=Utils.judgeAncestralalle1(OUTgroups,'ALT',mindepthtojudefixed)
            if Anc_base_idx[0] :
